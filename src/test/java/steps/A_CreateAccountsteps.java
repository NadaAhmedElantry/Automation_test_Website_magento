...
public class A_CreateAccountsteps {
    ...
    {
      driver.findElement(By.id("firstname")).sendKeys("Nadaodd");
      driver.findElement(By.id("lastname")).sendKeys("Elantryyy");
      driver.findElement(By.id("email_address")).sendKeys("nad@mail.com");
